...
function EFFECT:Init(data)
    ...
    for i = 0,5 do -- some bawls for us.
        ...
        if lightball then
            ...
            lightball:SetVelocity(vec * 1000 * scale) -- it will bounce off walls so no need for normal.
            lightball:SetDieTime(life)
            lightball:SetStartAlpha(50)
            lightball:SetEndAlpha(255)
            lightball:SetStartSize(math.random(50,100))
            lightball:SetEndSize(10)
        ...
        for i = 0,times do
            ...
            if lightball then
                ...
                lightball:SetVelocity(vec * 300 * scale)
                lightball:SetDieTime(life)
                lightball:SetStartAlpha(math.random(200,255))
                lightball:SetEndAlpha(0)
                lightball:SetStartSize(0)
                lightball:SetEndSize(math.random(50,80) * scale)
                lightball:SetColor(200,200,200)
            ...
            if smoke then
                ...
                smoke:SetEndSize(math.random(40,50) * scale)
                ...
                smoke:SetVelocity(vec * 3000 * life * 2 * scale) -- it will bounce off walls so no need for normal.
